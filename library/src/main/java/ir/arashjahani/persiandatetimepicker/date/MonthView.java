...
import ir.arashjahani.persiandatetimepicker.date.MonthAdapter.CalendarDay;
...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller) {
        ...
        DAY_SELECTED_CIRCLE_SIZE = mController.getVersion() == PersianDatePickerDialog.Version.VERSION_1
...
//                : context.getResources().getDimensionPixelSize(R.dimen.mdtp_date_picker_view_animator_padding_v2);
    ...
    public int getMonthHeight() {
        int scaleFactor = mController.getVersion() == PersianDatePickerDialog.Version.VERSION_1 ? 2 : 3;
    ...
    protected int getMonthHeaderSize() {
        return mController.getVersion() == PersianDatePickerDialog.Version.VERSION_1
                ? MONTH_HEADER_SIZE
    ...
    private String getMonthAndYearString() {
        ...
        return PersianNumberUtils.toFarsi(
