 ...
 */
public class YearPickerView extends ListView implements OnItemClickListener, PersianDatePickerDialog.OnDateChangedListener {
    ...
    private final class YearAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                v.setAccentColor(mController.getAccentColor(), false);
            }
